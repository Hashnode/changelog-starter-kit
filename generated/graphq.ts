...
export type PostsQuery = { __typename?: 'Query', publication?: { __typename?: 'Publication', postsViaPage: { __typename?: 'PublicationPostPageConnection', nodes: Array<{ __typename?: 'Post', id: string, url: string, slug: string, title: string, subtitle?: string | null, brief: string, publishedAt: any, hasLatexInPost: boolean, tags?: Array<{ __typename?: 'Tag', id: string, name: string, slug: string }> | null, author: { __typename?: 'User', name: string, username: string, profilePicture?: string | null }, coverImage?: { __typename?: 'PostCoverImage', url: string } | null, content: { __typename?: 'Content', html: string, markdown: string } }>, pageInfo: { __typename?: 'OffsetPageInfo', hasNextPage?: boolean | null, nextPage?: number | null } } } | null };
